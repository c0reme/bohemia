...
// This is the config for the postgres server
const config = {
    host: 'localhost',
    port: 5432,
    database: 'bohemia',
...
describe(config.host, () => {
    ...
    describe('CREATE', async () => {
        ...
        test('SEQUENCE THEN TABLE bohemia.address', async () => {
            ...
            const res = await client.query(`CREATE TABLE bohemia.address (${[
        ...
        test('SEQUENCE THEN TABLE bohemia.employee', async () => {
            ...
            const res = await client.query(`CREATE TABLE bohemia.employee (${[
        ...
        test('SEQUENCE THEN TABLE bohemia.project', async () => {
            ...
            const res = await client.query(`CREATE TABLE bohemia.project (${[
        ...
        test('SEQUENCE THEN TABLE bohemia.studio', async () => {
            ...
            const res = await client.query(`CREATE TABLE bohemia.studio (${[
        ...
        test('SEQUENCE THEN TABLE bohemia.employeeContract', async () => {
            ...
            const res = await client.query(`CREATE TABLE bohemia.\"employeeContract\" (${[
        ...
        test('SEQUENCE THEN TABLE bohemia.projectAssignment', async () => {
            ...
            const res = await client.query(`CREATE TABLE bohemia.\"projectAssignment\" (${[
